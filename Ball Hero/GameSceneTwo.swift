...
class GameSceneTwo: SKScene, SKPhysicsContactDelegate  {
    ...
    override func didMoveToView(view: SKView) {
        ...
        NSUserDefaults.standardUserDefaults().setObject(2, forKey: "currentLevel")
    ...
    func highScore(score: Double) -> Bool {
        var isHigh = Bool()
        if NSUserDefaults.standardUserDefaults().objectForKey("highScoreLevelTwo") != nil {
            let oldScore = NSUserDefaults.standardUserDefaults().objectForKey("highScoreLevelTwo") as! Double
            if score > oldScore {
                NSUserDefaults.standardUserDefaults().setObject(score, forKey: "highScoreLevelTwo")
                isHigh = true
            } else {
                isHigh = false
            }
